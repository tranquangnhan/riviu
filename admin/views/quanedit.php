            ...
            <div class="col-lg-4 mt-3">
                <nav aria-label="breadcrumb ">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Quán</a></li>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <img src="<?=$motQuan['img']?>" alt="" width="200">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" value="<?=$motQuan['diachi']?>" name="diachi" id="" class="form-control" placeholder="Tên Khách Hàng" aria-describedby="helpId" required>
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-lg-3">
                                    <label for=""><strong>Tên Quán</strong></label>
                                </div>
                                <div class="col-lg-9">
                                    <input type="text"  value="<?=$motQuan['tenquan']?>" name="tenquan" id="" class="form-control" placeholder="Tên Quán" aria-describedby="helpId" required>
                                </div>
                            </div>
                            <div class="row mt-5">
