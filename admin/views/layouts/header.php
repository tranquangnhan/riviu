                ...
                <div class="col-lg-2 nav-left bg-white">
                    ...
                    <div class="nav-main mt-3">
                        <ul>
                            ...
                            <li class="<?php if(isset($_GET['ctrl']) &&$_GET['ctrl']=="monan") echo "active";?>">
                                <div class="nav-link">
                                    ...
                                    <div class="nav-main__text "><div id="bv" class="click_title">Món Ăn</div>
                                        <div class="menu-alert">
                                            <ul>
                                                <li><a href="index.php?ctrl=monan&act=add">Thêm Mới</a></li>
                                                <li><a href="index.php?ctrl=monan&act=index">Danh Sách</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
